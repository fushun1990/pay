 ...
 */
@Data
public class PaySyncResponseWeiXinXCXCmd extends PaySyncResponseCmd {

    private PaySyncResponseValidatorDTO PaySyncResponseValidatorDTO;

    @Override
    public PaySyncResponseValidatorDTO getPaySyncResponseValidatorTO() {
        return PaySyncResponseValidatorDTO;
    }
}
