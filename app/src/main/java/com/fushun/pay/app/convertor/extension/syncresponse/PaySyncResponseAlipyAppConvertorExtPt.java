...
public class PaySyncResponseAlipyAppConvertorExtPt implements PaySyncResponseConvertorExtPt<PaySyncResponseAlipayAppDTO> {

    @Autowired
    private PaySyncResponseConvertor payConvertor;

    @Override
    public PayE clientToEntity(PaySyncResponseAlipayAppDTO paySyncResponseAlipayAppCO, BizScenario bizScenario) {
