...
public class PayNotitfyWeixinAppConvertorExt implements PayNotifyConvertorExtPt<PayNotifyThirdPartyWeixinAppDTO> {

    @Autowired
    private PayNotifyConvertor payConvertor;

    @Override
    public PayE clientToEntity(PayNotifyThirdPartyWeixinAppDTO payNotifyThirdPartyWeixinAppDTO, BizScenario bizScenario) {
        PayE payE = payConvertor.clientToEntity(payNotifyThirdPartyWeixinAppDTO, bizScenario);
        return payE;
    }
}
