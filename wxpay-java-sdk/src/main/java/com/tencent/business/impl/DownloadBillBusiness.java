...
import com.tencent.service.impl.DownloadBillService;
 ...
 * Time: 10:45
 */
public class DownloadBillBusiness extends BaseBusiness<DownloadBillReqData, DownloadBillResData> {
    ...
    @Override
    protected void execute(DownloadBillReqData downloadBillReqData, ResultListener<DownloadBillResData> resultListener) throws Exception {
        ...
        try {
            ...
            if (downloadBillResData == null || downloadBillResData.getReturn_code() == null) {
                ...
                resultListener.onFail(downloadBillResData);
                return;
            }
            ...
            if (downloadBillServiceResponseString.equals(null) || downloadBillServiceResponseString.equals("")) {
                ...
                resultListener.onFail(downloadBillServiceResponseString);
            } else {
                setResult("Case3:对账单API系统成功返回数据", Log.LOG_TYPE_INFO);
                resultListener.onFail(downloadBillServiceResponseString);
            }
            resultListener.onSuccess(downloadBillResData);
            returnCode = "SUCCESS";
        } finally {

            ReportReqData reportReqData = new ReportReqData(downloadBillReqData.getDevice_info(), downloadBillReqData.getConfigure());
            reportReqData.setInterface_url(ApiConfigure.DOWNLOAD_BILL_API);
            ...
            reportReqData.setUser_ip(downloadBillReqData.getConfigure().getIp());

            long timeAfterReport;
            if (downloadBillReqData.getConfigure().isUseThreadToDoReport()) {
