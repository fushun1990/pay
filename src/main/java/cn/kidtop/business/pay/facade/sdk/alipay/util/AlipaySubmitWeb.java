package cn.kidtop.business.pay.facade.sdk.alipay.util;
...
import cn.kidtop.framework.spring.SpringContextUtil;
...
import cn.kidtop.business.pay.facade.sdk.alipay.sign.MD5;
import cn.kidtop.business.pay.facade.sdk.alipay.util.httpclient.HttpProtocolHandler;
import cn.kidtop.business.pay.facade.sdk.alipay.util.httpclient.HttpRequest;
import cn.kidtop.business.pay.facade.sdk.alipay.util.httpclient.HttpResponse;
import cn.kidtop.business.pay.facade.sdk.alipay.util.httpclient.HttpResultType;
...
//    }
     ...
     */
    public static String send(String strParaFileName, String strFilePath,Map<String, String> sParaTemp)throws Exception{
          ...
          request.setUrl(ALIPAY_GATEWAY_NEW+"_input_charset="+alipayConfig.getInputCharset());

          HttpResponse response = httpProtocolHandler.execute(request,strParaFileName,strFilePath);
          if (response == null) {
              return null;
          }
          response.setCharset(alipayConfig.getInputCharset());
